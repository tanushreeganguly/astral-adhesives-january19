   ...
   if($resume_title!='') 
    ...
    if($flag==true && strlen($error)<=0){
       ...
       $insertarray = array(
        ...
        $result = $objTypes->fetchAll("SELECT * FROM tbl_career_apply WHERE email = '".$email."' and job_id=0 and is_delete = 1 and is_active = 1");
          ...
          <div class="cr_form_con">
            ...
            <ul class="loc_info">
              ...
              <li>
                ...
                <span>
                  <input type="text" name="email" id="email" value="<?php echo $decodeemail;?>" class="textBox">
                </span>
              </li>
             <li>
