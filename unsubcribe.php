...
<div class="sign_up_con">
	        ...
	        <script type="text/javascript" src="<?=base_url?>js/TweenMax.min.js"></script>
	        <script type="text/javascript" src="<?=base_url?>js/waypoints.js"></script>
	        <script type="text/javascript" src="<?=base_url?>js/jquery.slimmenu.js"></script>
	        <script type="text/javascript" src="<?=base_url?>js/custom.js"></script>
	        <script type="text/javascript" src="<?=base_url?>js/html5shiv-printshiv.js"></script>
	        <script type="text/javascript" src="<?=base_url?>js/jquery.flexslider.js"></script>
	        <script type="text/javascript" src="<?=base_url?>js/flexslider-setup.js"></script>
	        <script type="text/javascript" src="<?=base_url?>js/owl.carousel-beta.js"></script>
