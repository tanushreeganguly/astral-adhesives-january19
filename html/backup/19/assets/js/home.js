...
function setCubeRolloverEffect() {
    function set3dEffect() {
        ...
        function maintenanceAnim(){
            var intervalId;
            var returnObj = createAnimDivForHoverEffect({ id: '#maintenance' });
            var tilesHolder = returnObj.tilesHolder;
            var animDiv = returnObj.animDiv;

            var str = '<div class="leftAnimHld">';
            str += '<img class="bottle_1" src="assets/images/application-hover/maintenance/bottle-01.jpg"></img>';
            str += '<img class="bottle_2" src="assets/images/application-hover/maintenance/bottle-02.jpg"></img>';
            str += '</div>';
            var leftAnimHolder = $(str);
            animDiv.append(leftAnimHolder);

            var str = '<div class="rightAnimHld">';
            str += '<img class="tube_1" src="assets/images/application-hover/maintenance/tube-01.jpg"></img>';
            str += '<img class="tube_2" src="assets/images/application-hover/maintenance/tube-02.jpg"></img>';
            str += '</div>';
            var leftAnimHolder = $(str);
            animDiv.append(leftAnimHolder);
            var tl = new TimelineLite()
                .add('startPoint', '+=0.7')
            tl.from('#maintenance .bottle_1', 0.6, { y: 40, opacity: 0, ease: Sine.easeOut }, 'startPoint')
            tl.from('#maintenance .bottle_2', 0.6, { y: 40, opacity: 0, ease: Sine.easeOut }, 'startPoint+=0.4')
            tl.from('#maintenance .tube_1', 0.6, { y: -60, opacity: 0, ease: Sine.easeOut }, 'startPoint+=0.8')
            tl.from('#maintenance .tube_2', 0.6, { y: 60, opacity: 0, ease: Sine.easeOut }, 'startPoint+=0.8')
            tl.seek(0);
            tl.pause();
        ...
        //---  I N D U S T R I A L  -------------------------------------------------------
        function industrialAnim(){
            var intervalId;
            var returnObj = createAnimDivForHoverEffect({ id: '#industry' });
            var tilesHolder = returnObj.tilesHolder;
            var animDiv = returnObj.animDiv;
            var str = '<div class="ind_anim_lt">';
            str += '<img class="workshop" src="assets/images/application-hover/industry/industry.png"></img>';
            str += '</div>';
            var leftAnimHolder = $(str);
            animDiv.append(leftAnimHolder);

            var str = '<div class="ind_anim_rt">';
            str += '<img class="chimani_02" src="assets/images/application-hover/industry/chimani-02.png"></img>';
            str += '<img class="chimani_01" src="assets/images/application-hover/industry/chimani-01.png"></img>';
            str += '<img class="cloud" src="assets/images/application-hover/industry/cloud.png"></img>';
            str += '</div>';
            var leftAnimHolder = $(str);
            animDiv.append(leftAnimHolder);
            ...
            var tl = new TimelineLite()
                .add('startPoint', '+=0.7')
            tl.from('#industry .workshop', 0.6, { x: -40, opacity: 0, ease: Sine.easeOut }, 'startPoint')
            tl.from('#industry .chimani_01', 0.4, { y: 40, opacity: 0, ease: Sine.easeOut }, 'startPoint+=0.4')
            tl.from('#industry .chimani_02', 0.4, { y: 40, opacity: 0, ease: Sine.easeOut }, 'startPoint+=0.8')
            tl.from('#industry .cloud', 0.4, { opacity: 0, ease: Sine.easeOut }, 'startPoint+=0.8')
            tl.seek(0);
            tl.pause();
            setOverOutFun({ tilesHolder: tilesHolder, tl: tl });
        ...
        function accessoriesApp() {
            ...
            var tl = new TimelineLite()
                .add('startPoint', '+=0.7')
            tl.from('#accessoriesApp .glueGun', 0.5, { y: -40, x: -40, opacity: 0, ease: Sine.easeOut }, 'startPoint')
