  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <?php
		...
		$where      	= array(":is_delete" => '1' , ":is_active" => '1',":id" => '4');
		$aboutadhesiveArr 	= $objTypes->select("tbl_pages", "*", "is_delete = :is_delete and is_active = :is_active and id=:id ", $where, $order);
		if(isset($aboutadhesiveArr) && sizeof($aboutadhesiveArr) > 0){
			foreach ($aboutadhesiveArr as $adhesive_value){
				
				echo stripcslashes($adhesive_value['description']);
		 } }?>
		<section>
			...
			<form id="enguiry" method="post"action="#form_contact" >
				 <div><input type="hidden" name="data" value="1"></div>
				  <div class="fileldsCon">
					...
					<div class="fieldHolder">
						<input type="text" class="formTextBox" name="name" placeholder="Full Name" onFocus="if (this.value == 'Full Name*') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Full Name*';}" value="Full Name*" id="name">
					</div>
					<div class="fieldHolder">
						<input type="text" class="formTextBox" name="email" placeholder="Email ID*" onFocus="if (this.value == 'Email ID*') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Email ID*';}" value="Email ID*" id="email">
					</div>
					<div class="fieldHolder">
						<select name="country" id="country" class="formSelectBox">
					...
					<div class="fieldHolder">
						<select name="state" id="state" class="formSelectBox">
					...
					<div class="fieldHolder">
						<select name="city" id="city" class="formSelectBox">
					...
					<div  class="fieldHolder">
						<input type="text" class="formTextBox" name="zip" placeholder="Zip" onFocus="if (this.value == 'Zip') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Zip';}" value="" id="zip" maxlength="8" onKeyPress="return validateNumbersOnly(event)">
					</div>
					
					<div  class="fieldHolder">
						<input type="text" class="formTextBox" name="phone" placeholder="Phone" onFocus="if (this.value == 'Phone') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Phone';}" value="" id="phone" maxlength="12" onKeyPress="return validateNumbersOnly(event)">
					</div>
					<div class="fieldHolder">
						<input type="text" class="formTextBox" name="mobile" placeholder="Mobile*" onFocus="if (this.value == 'Mobile*') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Mobile*';}" value="Mobile*" id="mobile" maxlength="10" onKeyPress="return validateNumbersOnly(event)">
					</div>
					<div  class="fieldHolder">
						<input type="text" class="formTextBox" name="product" placeholder="Product" onFocus="if (this.value == 'Product') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Product';}" value="" id="Product">
					</div>
					<div class="fieldHolder">
						<textarea rows="2" cols="40" class="textArea" placeholder="Address" onFocus="if (this.value == 'Address') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Address';}" name="address" id="address"></textarea>
					</div>
					
					<div class="fieldHolder">
						<textarea cols="30" rows="4" class="textArea" placeholder="Message" onFocus="if (this.value == 'Message') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Message';}" name="description" id="description"></textarea>
					</div>
				  </div>
				  <div class="btnHolder">
						 <input type="button" class="commanBtn" value="Know More" name="submit" id="enquireNow">
