...
$TypeArray	= $objTypes->fetchRow("SELECT * FROM tbl_event WHERE id = :id", $params);
?>

<div class="content-wrapper">
  <!-- Content Header (Page header) -->
  <section class="content-header">
    <h1> <?=$mode?> Event<small></small> </h1>
    <ol class="breadcrumb">
      <li><a href="list_event.php"><i class="fa fa-navicon"></i> Press release List</a></li>
    </ol>
  </section>
  <!-- Main content -->
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary" >
          ...
          <form role="form" method="post" action="act_event.php" onsubmit="return validateForm();" enctype="multipart/form-data">
           ...
           <input type="hidden" name="pgNo" id="pgNo" value="<?=$_REQUEST['pgNo']?>"  />
			...
			<div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" placeholder="Short Description..." name="short_description" id="editor1" rows="3" style="width:40%;"><?=($TypeArray['short_description'])?></textarea>
              </div>
              <div class="form-group">
			  ...
			  <div class="form-group">
                ...
                <div class="alert alert-danger alert-dismissible" style="width:40%;margin-top:10px;">[Note:- File Size : 405X175  , MAX File Upload Size : 3MB]</div>
                <?php if($TypeArray['thumbnail']){ ?>
                <a href="#" id='existing_image'><img src="../uploads/event_images/<?=stripslashes($TypeArray['thumbnail'])?>"  onerror="this.style.display='none'" height="80" width="100" onclick='window.open("../uploads/testimonial_images/<?=stripslashes($TypeArray['thumbnail'])?>","","width=600,height=600,scrollbars=Yes,resizable=yes")' /></a>
				<?php } ?>
              </div>					
              <div class="form-group">
            ...
            <div class="box-footer">
              ...
              <a href="list_event.php?&pgNo=<?php echo intval(base64_decode($_REQUEST['pgNo'])); ?>" class="btn btn-danger" >Back</a>
            </div>
          </form>
        </div>
        <!-- /.box -->
